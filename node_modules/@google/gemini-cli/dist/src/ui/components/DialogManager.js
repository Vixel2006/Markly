...
export const DialogManager = () => {
    ...
    if (uiState.showIdeRestartPrompt) {
        return (_jsx(Box, { borderStyle: "round", borderColor: theme.status.warning, paddingX: 1, children: _jsx(Text, { color: theme.status.warning, children: "Workspace trust has changed. Press 'r' to restart Gemini to apply the changes." }) }));
    }
