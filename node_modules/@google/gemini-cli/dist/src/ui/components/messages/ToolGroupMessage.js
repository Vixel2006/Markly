...
export const ToolGroupMessage = ({ toolCalls, availableTerminalHeight, terminalWidth, isFocused = true, activeShellPtyId, shellFocused, }) => {
    const isShellFocused = shellFocused &&
    ...
    const borderColor = isShellCommand || isShellFocused
        ? theme.ui.symbol
        : hasPending
        ...
        width: "100%", marginLeft: 1, borderDimColor: hasPending, borderColor: borderColor, gap: 1, children: toolCalls.map((tool) => {
            ...
            return (_jsxs(Box, { flexDirection: "column", minHeight: 1, children: [_jsx(Box, { flexDirection: "row", alignItems: "center", children: _jsx(ToolMessage, { ...tool, availableTerminalHeight: availableTerminalHeightPerToolMessage, terminalWidth: innerWidth, emphasis: isConfirming
                                ...
                                : toolAwaitingApproval
                                    ? 'low'
                                    : 'medium', activeShellPtyId: activeShellPtyId, shellFocused: shellFocused, config: config }) }), tool.status === ToolCallStatus.Confirming &&
                        isConfirming &&
