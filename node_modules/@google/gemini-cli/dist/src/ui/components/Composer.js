...
export const Composer = () => {
    ...
    return (_jsxs(Box, { flexDirection: "column", children: [!uiState.shellFocused && (_jsx(LoadingIndicator, { thought: uiState.streamingState === StreamingState.WaitingForConfirmation ||
                    config.getAccessibility()?.disableLoadingPhrases
                    ? undefined
                    : uiState.thought, currentLoadingPhrase: config.getAccessibility()?.disableLoadingPhrases
                    ? undefined
                    : uiState.currentLoadingPhrase, elapsedTime: uiState.elapsedTime })), !uiState.isConfigInitialized && _jsx(ConfigInitDisplay, {}), uiState.messageQueue.length > 0 && (_jsxs(Box, { flexDirection: "column", marginTop: 1, children: [uiState.messageQueue
                        ...
                        return (_jsx(Box, { paddingLeft: 2, width: "100%", children: _jsx(Text, { dimColor: true, wrap: "truncate", children: preview }) }, index));
                                    ...
                                    MAX_DISPLAYED_QUEUED_MESSAGES, ' ', "more)"] }) }))] })), _jsxs(Box, { marginTop: 1, justifyContent: settings.merged.ui?.hideContextSummary
                    ? 'flex-start'
