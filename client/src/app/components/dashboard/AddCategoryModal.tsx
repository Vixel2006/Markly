        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900">Add New Category</h2> {/* Consistent heading color */}
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label htmlFor="emoji" className="block text-sm font-medium text-slate-700 mb-1">
                  Emoji (Optional)
                </label>
                <input
                  type="text"
